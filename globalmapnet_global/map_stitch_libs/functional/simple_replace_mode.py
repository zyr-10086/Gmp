    ...
    for category in map_elements.keys():
        ...
        while len(indices) > 0:
            ...
            for index2 in indices:
                ...
                # point distance 来计算是否匹配成功，存储到matched_pairs中
        ...
        while len(matched_pairs) > 0:
            ...
            # 对matched_pairs进行更新，判断在剩下的pairs里有没有和之前合并元素相关的，如果有，则更新pairs
            # 它这里索引有正有负，正负代表方向
